...
@section('content')
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                <label for="" class="fw-bold"><i class="fa-solid fa-location-dot"></i> Tujuan
                                    Supplier (Nama Perusahaan)</label>
                                <select name="id_tujuan" id="id_tujuan"
                                    class="form-control @error('id_tujuan') is-invalid @enderror">
                                    <option value="1" selected disabled>-- Pilih Supplier --</option>
                                    @foreach ($supplier as $data)
                                        <option data-id="{{ $data->id_perusahaan }}" data-class="SUPPLIER"
                                            value="{{ $data->id_perusahaan }}">{{ $data->id_perusahaan }} -
                                            {{ $data->nama }}</option>
                                    @endforeach
                                </select>
                                @error('id_tujuan')
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="po_number" class="fw-bold"><i class="fa-solid fa-envelope"></i> PO
                                    Number</label>
                                <input type="text" class="form-control @error('po_number') is-invalid @enderror"
                                    id="po_number" placeholder="Masukkan po_number" value="{{ old('po_number') }}">
                                @error('po_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="destination" class="fw-bold"><i class="fa-solid fa-truck"></i> Tujuan Pengiriman
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                <label for="default_id" class="fw-bold"><i class="fa-solid fa-address-card "></i> ID Default
                                    Supplier</label>
                                <input type="text" class="form-control @error('default_id') is-invalid @enderror"
                                    id="default_id" placeholder="Masukkan default_id" value="{{ old('default_id') }}">
                                @error('default_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="issue_date" class="fw-bold"><i class="fa-solid fa-calendar-days"></i> Issue
                                    Date</label>
                                <input type="text" class="form-control @error('issue_date') is-invalid @enderror"
                                    id="issue_date" placeholder="Masukkan issue_date">
                                @error('issue_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                <label for="classname" class="fw-bold"><i class="fa-solid fa-people-group"></i>
                                    Class</label>
                                <input type="text" class="form-control @error('class') is-invalid @enderror"
                                    id="classname" placeholder="Masukkan class">
                                @error('classname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="container">
                <form class="temp">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                ...
                                <input type="text" class="form-control @error('part_no') is-invalid @enderror"
                                    id="part_no" placeholder="Masukkan part_no">
                                @error('part_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="composition" class="fw-bold"><i class="fa-solid fa-calculator"></i>
                                    Composition</label>
                                <input type="text" class="form-control @error('composition') is-invalid @enderror"
                                    id="composition" placeholder="Masukkan composition">
                                @error('composition')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                ...
                                <input type="text" class="form-control @error('part_name') is-invalid @enderror"
                                    id="part_name" placeholder="Masukkan part_name">
                                @error('part_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="unit" class="fw-bold"><i class="fa-solid fa-weight-scale"></i>
                                    Unit</label>
                                <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                    id="unit" placeholder="Masukkan unit">
                                @error('unit')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="amount" class="fw-bold"><i class="fa-solid fa-calculator"></i>
                                    Amount</label>
                                <input type="text" class="form-control @error('amount') is-invalid @enderror"
                                    id="amount" placeholder="Masukkan amount">
                                @error('amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-start">
                                <label for="unit_price" class="fw-bold"><i class="fa-solid fa-money-check-dollar"></i>
                                    Unit Price</label>
                                <input type="text" class="form-control @error('unit_price') is-invalid @enderror"
                                    id="unit_price" placeholder="Masukkan unit_price">
                                @error('unit_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="order_number" class="fw-bold"><i class="fa-solid fa-tag"></i> Order
                                    Number</label>
                                <input type="text" class="form-control @error('order_number') is-invalid @enderror"
                                    id="order_number" placeholder="Masukkan order_number">
                                @error('order_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-3 text-start">
                                <label for="delivery_date" class="fw-bold"><i class="fa-solid fa-tag"></i> Delivery
                                    Date</label>
        ...
        <a href="javascript:void(0);" id="tambah" style="margin-left: 900px"
            class="mt-3 btn btn-success disabled shadow-sm"><i class="fa-solid fa-circle-plus"></i> Tambah Item</a>
        <form id="formPO" method="POST" action="{{ route('hki.po.supplier.store') }}"
            ...
            <button style="margin-left: 900px" type="submit" id="simpan" class="btn btn-primary shadow fw-bold"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#po_number').keyup(function() {
                date = new Date();
                const issue_date = $('#issue_date').val(date.toLocaleDateString('id-ID') + ' - ' + date
        ...
        $('#tambah').click(function() {
            ...
            $('#myTable tbody').append('<tr id=row' + no + ' class="child">' +
                ...
                '<td><input class="form-control" name="unit_price[]" value=' + $('#unit_price').val() +
                '></td>' +
                '<td><input class="form-control" name="composition[]" value=' + $('#composition').val() +
                '></td>' +
                ...
                '<td><input class="form-control" name="order_number[]" value=' + $('#order_number').val() +
                '></td>' +
                '<td><input class="form-control" type="hidden" name="delivery_date[]" value=' + $(
